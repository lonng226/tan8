package lonng.com.tan8.invitation;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.edit_image_grid_fragment, container, false);
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.edit_choose_griditem, container, false);
...
//				holder.tvSize.setText(TextFormater.getDataSize(entty.size));
                holder.tvDur.setText(CommonUtils.timeToString(entty.duration));
                holder.tvSize.setText(CommonUtils.sizeToString(entty.size));
