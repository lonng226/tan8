...
*
 */
public class CirclePublicCommentContralBank {
	private static final String TAG = CirclePublicCommentContralBank.class.getSimpleName();
	...
	public CirclePublicCommentContralBank(Context context, View editTextBody, EditText editText, View sendBt){
		mContext = context;
	...
	* @throws
	...
	public void handleListViewScroll() {
		int headHeight =  ((BankActivity)mContext).getHeadHeight();
		int keyH = TanApplication.mKeyBoardH;//键盘的高度

		int editTextBodyH = ((BankActivity)mContext).getEditTextBodyHeight();//整个EditTextBody的高度
